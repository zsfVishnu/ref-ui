...
import { Search, Plus, ExternalLink, Calendar, MapPin, Users, Filter } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div>
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6">
            <h2 className="text-2xl font-bold text-black mb-4 lg:mb-0">Active Referral Events</h2>
            {user?.role === 'referrer' && (
              <Dialog>
                <DialogTrigger asChild>
          ...
          {referralEvents.length === 0 && (
            <div className="text-center py-12">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">No active referral events</h3>
